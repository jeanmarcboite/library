...
<style>
  ...
  .track {
    @apply w-12 h-6 bg-pink-600 rounded-full shadow-inner;
  }

  .thumb {
    @apply transition-all duration-300 ease-in-out absolute top-0 left-0 w-6 h-6 bg-pink-100 border-2 border-pink-600 rounded-full;
  }
