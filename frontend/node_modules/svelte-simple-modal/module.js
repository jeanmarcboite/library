import { setContext, SvelteComponent as SvelteComponent$1 } from 'svelte';
...
// (260:10) {#if isSvelteComponent(state.closeButton)}
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (default_slot && default_slot.p && dirty[1] & /*$$scope*/ 512) {
